...
public class MvcConfiguration implements WebMvcConfigurer {
    ...
    public void addViewControllers(ViewControllerRegistry registry) {
        ...
        registry.addViewController("/book").setViewName("forward:/book/category");
        registry.addViewController("/category").setViewName("forward:/book/category");
        registry.addViewController("/book/index").setViewName("forward:/book/category");
